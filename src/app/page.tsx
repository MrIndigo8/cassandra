      ...
      <main className="flex-1 flex flex-col items-center justify-center px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-6 leading-tight">
            <span className="text-mist">Коллективное</span>
            <br />
            <span className="text-gradient">предосознание</span>
          </h1>

          {/* Подзаголовок */}
          <p className="text-lg sm:text-xl text-mist-dim max-w-2xl mx-auto mb-10 leading-relaxed">
            Записывайте сны и предчувствия. Искусственный интеллект находит
            совпадения с реальными событиями мира. Исследуйте{" "}
            <span className="text-accent-light">синхронии Юнга</span> в
          ...
          <p className="text-xs text-mist-faint max-w-md mx-auto">
            Инструмент наблюдения и исследования, не пророчество.
            Основано на концепции синхронии К.Г. Юнга.
          </p>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="card text-center group">
              ...
              <h3 className="text-lg font-semibold text-mist mb-2">Записывайте</h3>
              <p className="text-mist-dim text-sm">
                Фиксируйте сны и предчувствия сразу после пробуждения.
                Точная метка времени — ваш ключ к верификации.
              </p>
            </div>
            ...
            <div className="card text-center group">
              ...
              <h3 className="text-lg font-semibold text-mist mb-2">ИИ анализирует</h3>
              <p className="text-mist-dim text-sm">
                Claude извлекает символы, эмоции и темы. Сравнивает с потоком
                мировых событий в реальном времени.
              </p>
            </div>
            ...
            <div className="card text-center group">
              ...
              <h3 className="text-lg font-semibold text-mist mb-2">Совпадения</h3>
              <p className="text-mist-dim text-sm">
                Когда ваш образ совпадает с реальным событием — вы получаете
                уведомление. Рейтинг точности растёт.
              </p>
            </div>
          </div>
        </div>
      ...
      <footer className="border-t border-void-border/50 py-8 px-4">
        <div className="max-w-7xl mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-xs text-mist-faint">
            Инструмент наблюдения и исследования. Не является средством предсказания будущего.
          </p>
        </div>
      </footer>
    </div>
