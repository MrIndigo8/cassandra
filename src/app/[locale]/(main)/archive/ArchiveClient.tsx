  ...
  return (
    <div>
      ...
      {filtered.length > 0 ? (
              ...
              <div key={item.id} className="bg-white border border-gray-100 rounded-2xl p-6 shadow-sm hover:shadow-md transition-shadow">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    ...
                    <div className="text-sm font-medium text-gray-500 flex flex-wrap items-center gap-2 mt-1">
                  ...
                  <div className="flex items-center gap-2 shrink-0">
                    <span className="px-2.5 py-1 bg-gray-100 text-gray-600 text-[10px] uppercase font-bold tracking-wider rounded">
                ...
                <div className="relative pl-6 border-l-2 border-primary/30 mb-4 py-1">
                  <span className="absolute -left-[14px] top-1 w-6 h-6 bg-white border-2 border-primary/30 rounded-full flex items-center justify-center text-[10px]">👁️</span>
                  <p className="text-gray-700 italic text-base">«{vision}»</p>
                </div>

                {/* Arrow Connector */}
                <div className="flex flex-col items-start pl-[5px]">
                  <svg className="w-4 h-6 text-gray-300 animate-pulse" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 14l-7 7m0 0l-7-7m7 7V3" /></svg>
                </div>

                {/* Event Box */}
                <div className="relative pl-6 border-l-2 border-accent/50 mt-1 py-1">
                  <span className="absolute -left-[14px] top-1 w-6 h-6 bg-white border-2 border-accent/50 rounded-full flex items-center justify-center text-[10px]">🎯</span>
                  <p className="text-gray-900 font-medium mb-1 leading-relaxed">{eventDesc}</p>
                  <p className="text-xs font-mono text-gray-500">{new Date(item.date_of_event).toLocaleDateString(locale)}</p>
                </div>
                ...
                <div className="mt-6 flex items-center justify-between pt-4 border-t border-gray-50">
                  ...
                  {item.source_url && (
                    <a href={item.source_url} target="_blank" rel="noopener noreferrer" className="text-xs text-blue-500 hover:text-blue-700 hover:underline flex items-center gap-1 font-medium transition-colors">
        ...
        <div className="h-40 flex flex-col items-center justify-center bg-gray-50 border border-gray-100 border-dashed rounded-xl text-gray-400">
